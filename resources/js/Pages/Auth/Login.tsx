...
const Login: React.FC<Props> = (props) => {
    ...
    return (
        <>
            <Head title="Account Login | BornoBangla.com" meta-description="Your page description"/>
            <Layout>
                        ...
                        <div className="flex xl:justify-center lg:justify-between justify-center items-center flex-wrap h-full g-6">
                            ...
                            <div className="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
                                ...
                                <form onSubmit={handleSubmit}>
                                    <div className="mb-6">
                                        <input type="email" className="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                        name="email" 
                                        value={state.email}
                                    ...
                                    <div className="text-center lg:text-left">
                                        ...
                                        <p className="text-sm font-semibold mt-2 pt-1 mb-0"> Don't have an account? <Link href={ base_url + '/register'} className="text-red-600 hover:text-red-700 focus:text-red-700 transition duration-200 ease-in-out"> Register</Link>
                                        </p>
                                    </div>
                                </form>
                            
                                <div className="w-full mt-4 overflow-x-auto relative">
