...
const Register = () => {
    ...
    return (
        <>
        <Head title="User Register | BornoBangla.com" meta-description="Your page description"/>
        <Layout>
                ...
                <div className="text-gray-500 w-full">
                        <div className="md:flex w-full">
                            ...
                            <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                                ...
                                <form onSubmit={handleSubmit} method="post" encType="multipart/form-data" className="">
                                    ...
                                    <div className="flex -mx-3">
                                        <div className="w-full px-3 mb-12">
                                            <label htmlFor="" className="text-xs font-semibold px-1">Confirmation Password</label>
                                            <div className="flex">
                                                <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                                                <input type="password" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" 
